...
namespace SBT.Test
{
    class Program
    {
        ...
        {
            // Команды для юнитов
            var commands = new List<ICommand> {new FireCommand(), new MoveCommandDecorator(new MoveCommand()), new RotateCommand()};
            // Юниты
            var units = new List<IUnit> {new Car(), new Tank(), new Fence(), new Chopper()};
